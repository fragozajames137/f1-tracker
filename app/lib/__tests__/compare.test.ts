...
describe("computeDriverMetrics", () => {
  const session: TelemetrySession = {
    ...
    stintData: [
      { driverNumber: 1, stintNumber: 1, compound: "MEDIUM", lapStart: 1, lapEnd: 3 },
    ],
  };
...
describe("computeComparison", () => {
  const session: TelemetrySession = {
    ...
    stintData: [
      { driverNumber: 1, stintNumber: 1, compound: "MEDIUM", lapStart: 1, lapEnd: 2 },
      { driverNumber: 4, stintNumber: 1, compound: "SOFT", lapStart: 1, lapEnd: 2 },
    ],
  };
